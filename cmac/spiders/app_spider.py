...
from cmac.items import CmacItem


class CmacSpider(scrapy.Spider):
    name = "cmac"
    start_urls = [
        'https://cmacapps.com',
    ]
    ...
    def parse_detail(self, response):
        ...
        if 'wpappbox' in response.text:
            screenshots = response.xpath(
                "//div[contains(@class, 'wpappbox')]/div[@class='screenshots']/div/ul/li/img/@src").extract()
